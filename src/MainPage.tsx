  ...
  return (
    ...
    {!loading && !gameOver && userAnswers.length === number +1 && number !== TOTAL_QUESTIONS-1 ?<button className="next" onClick={nextQuestion}>
      Next Question
          ...
          {Winner() && userAnswers.length === TOTAL_QUESTIONS ? <p>Congratulations!! Awesome Job. You got {percentage}% result.</p> : !Winner() && userAnswers.length === TOTAL_QUESTIONS ?<p>Please Try again. You have got {percentage}% result. </p>:null}
